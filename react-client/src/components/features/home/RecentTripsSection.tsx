...
const RecentTripsSection: React.FC<RecentTripsSectionProps> = ({
  trips,
  loading,
  error,
}) => {
    ...
    <Container maxW="6xl" py={12}>
      ...
      {loading ? (
        ...
        <VStack
          ...
          borderRadius="lg"
        >
          <FaImage size={40} color={noTripsIconColor} />
          <Heading as="h3" size="md">
            No trips yet
          </Heading>
          <Text>
            Start by creating your first trip to document your adventures.
          </Text>
          <Button
            as={RouterLink}
            to="/trips/new"
